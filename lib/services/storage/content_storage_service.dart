...
class ContentStorageService {
  ...
  Future<bool> contentExists(String contentType) async {
    final filename = '$contentType.json';
    return await _fileExists(filename);
  }

  Future<Map<String, Map<String, dynamic>>> getContentMetadata() async {
    final contentTypes = [
  ...
  int _getItemCount(Map<String, dynamic> data, String contentType) {
