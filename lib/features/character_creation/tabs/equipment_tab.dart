...
class _EquipmentTabState extends State<EquipmentTab> {
  ...
  List<Item> get filteredItems {
    return GlobalListManager()
        .itemList
        .where((element) =>
            ((element.equipmentType.contains("Armour") &&
                    element.equipmentType.any((item) =>
                        widget.character.armourList.contains(item))) ||
                (element.equipmentType.contains("Weapon") &&
                    element.equipmentType.any((item) =>
                        widget.character.weaponList.contains(item))) ||
                (element.equipmentType.contains("Item") &&
                    ((widget.character.itemList.contains("Stackable") &&
                            element.stackable) ||
                        (widget.character.itemList.contains("Unstackable") &&
                            !element.stackable)))) &&
            widget.coinTypesSelected.contains(element.cost[1] as String))
        .toList();
  }
                            ...
                            child: Column(
                                ...
                                children: [
                                    ...
                                    child: Row(children: [
                                      ...
                                      OutlinedButton(
                                        style: OutlinedButton.styleFrom(
                                            backgroundColor: (widget.character
                                                        .armourList.length ==
                                                    4)
                                        ...
                                        onPressed: () {
                                          setState(() {
                                            ...
                                            if (widget.character.armourList
                                                    .length ==
                                                4) {
                                      ...
                                      OutlinedButton(
                                        ...
                                        onPressed: () {
                                          setState(() {
                                            if (widget.character.weaponList
                                                    .length ==
                                                2) {
                                              widget.character.weaponList
                                                  .clear();
                                            } else {
                                              widget.character.weaponList = [
                                                "Ranged",
                                  ...
                                  OutlinedButton(
                                    style: OutlinedButton.styleFrom(
                                        backgroundColor:
                                            (widget.coinTypesSelected.length ==
                                                    5)
                                                ? ThemeManager.instance
                                                    .currentScheme.backingColour
                                                : unavailableColor),
                                    onPressed: () {
                                      setState(() {
                                        ...
                                        if (widget.coinTypesSelected.length ==
                                            5) {
                                  ...
                                  Container(
                                      ...
                                      decoration: BoxDecoration(
                                          color: ThemeManager.instance
                                              .currentScheme.backgroundColour,
                                          border: Border.all(
                                                ...
                                                onPressed: () {
                                                  setState(() {
                                                    if (filteredItems[index]
                                                        ...
                                                        widget.character
                                                                .currency[
                                                            "${filteredItems[index].cost[1]} Pieces"]) {
                                                      widget.character.currency[
                                                          "${filteredItems[index].cost[1]} Pieces"] = widget
                                                                  .character
                                                                  .currency[
                                                              "${filteredItems[index].cost[1]} Pieces"]! -
                                                          (filteredItems[index]
                        ...
                        child: Column(
                          children: [
                            ...
                            StyleUtils.buildStyledMediumTextBox(
                                text: "Choose equipment from options gained:"),
                            const SizedBox(height: 6),

                            /* A column containing each choice as a pair of buttons */
                            (widget.character.equipmentSelectedFromChoices
                                    .isEmpty)
                                ? StyleUtils.buildStyledSmallTextBox(
                                    text: "No equipment choices available")
                                : SizedBox(
                                    height: 300,
                                    child: SingleChildScrollView(
                                      child: Column(
                                                    ...
                                                    child: Row(
                                                      children: [
                                                        ...
                                                        ElevatedButton(
                                                          ...
                                                          child: Text(
                                                              produceEquipmentOptionDescription(widget
                                                                      .character
                                                                      .equipmentSelectedFromChoices[
                                                                  i][0]),
                                                              style: TextStyle(
