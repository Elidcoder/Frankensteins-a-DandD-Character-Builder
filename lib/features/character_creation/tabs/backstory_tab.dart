...
class _BackstoryTabState extends State<BackstoryTab> {
  ...
  void initState() {
    ...
    ageEnterController =
        TextEditingController(text: widget.character.characterDescription.age);
    heightEnterController = TextEditingController(
        text: widget.character.characterDescription.height);
    weightEnterController = TextEditingController(
        text: widget.character.characterDescription.weight);
    eyeColourController =
        TextEditingController(text: widget.character.characterDescription.eyes);
    skinEnterController =
        TextEditingController(text: widget.character.characterDescription.skin);
    hairEnterController =
        TextEditingController(text: widget.character.characterDescription.hair);
    backstoryEnterController = TextEditingController(
        text: widget.character.characterDescription.backstory);
    additionalFeaturesEnterController =
        TextEditingController(text: widget.character.extraFeatures);
  }
        ...
        child: Column(children: [
                ...
                children: [
                  ...
                  StyleUtils.buildStyledSmallTextField(
                      ...
                      onChanged: (characterAgeEnteredValue) {
                        setState(() {
                          widget.character.characterDescription.age =
                              characterAgeEnteredValue;
                  ...
                  StyleUtils.buildStyledSmallTextField(
                      ...
                      onChanged: (characterEyeEnteredValue) {
                        setState(() {
                          widget.character.characterDescription.eyes =
                              characterEyeEnteredValue;
                          widget.onCharacterChanged();
                        });
                      }),
                ],
                ...
                children: [
                  ...
                  StyleUtils.buildStyledSmallTextField(
                      ...
                      onChanged: (characterHeightEnteredValue) {
                        setState(() {
                          widget.character.characterDescription.height =
                              characterHeightEnteredValue;
                          widget.onCharacterChanged();
                        });
                      }),
                  const SizedBox(height: 10),
                  ...
                  StyleUtils.buildStyledSmallTextField(
                      ...
                      onChanged: (characterSkinEnteredValue) {
                        setState(() {
                          widget.character.characterDescription.skin =
                              characterSkinEnteredValue;
                          widget.onCharacterChanged();
                        });
                      }),
                ],
                ...
                children: [
                  ...
                  StyleUtils.buildStyledSmallTextField(
                      ...
                      onChanged: (characterWeightEnteredValue) {
                        setState(() {
                          widget.character.characterDescription.weight =
                              characterWeightEnteredValue;
                          widget.onCharacterChanged();
                        });
                      }),
                  const SizedBox(height: 10),
                  ...
                  StyleUtils.buildStyledSmallTextField(
                      ...
                      onChanged: (characterHairEnteredValue) {
                        setState(() {
                          widget.character.characterDescription.hair =
                              characterHairEnteredValue;
                          widget.onCharacterChanged();
                        });
                      }),
                ],
          ...
          StyleUtils.buildStyledLargeTextField(
              ...
              onChanged: (backstoryEnteredValue) {
                setState(() {
                  widget.character.characterDescription.backstory =
                      backstoryEnteredValue;
                  widget.onCharacterChanged();
                });
              }),
