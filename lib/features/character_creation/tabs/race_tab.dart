              ...
              children: [
                ...
                StyleUtils.buildStyledDropDown(
                    ...
                    onChanged: (String? value) {
                      setState(() {
                        widget.character.raceAbilityScoreIncreases = [
                          0,
                          0,
                          0,
                          0,
                        ...
                        widget.character.race = GlobalListManager()
                            .raceList
                            .singleWhere((x) => x.name == value);
                        widget.character.subrace =
                            widget.character.race.subRaces?.first;

                        for (int i = 0; i < abilityScores.length; i++) {
                          widget.character.raceAbilityScoreIncreases[i] =
                              widget.character.race.raceScoreIncrease[i] +
                                  ((widget.character.subrace
                                          ?.subRaceScoreIncrease[i]) ??
                                      0);
                  ...
                  StyleUtils.buildStyledDropDown(
                    ...
                    onChanged: (String? value) {
                      setState(() {
                        ...
                        widget.character.subrace = widget
                ...
                if (widget.character.race.mystery1S +
                        (widget.character.subrace?.mystery1S ?? 0) !=
                    0) ...[
                  StyleUtils.buildStyledSmallTextBox(
                      text: "Choose which score(s) to increase by 1"),
                  StyleUtils.buildNStyledAsiSelectors(
                      numbItems: (widget.character.race.mystery1S +
                          (widget.character.subrace?.mystery1S ?? 0)),
                      optionalStatesList: widget.character.optionalOnesStates!,
                      onPressed:
                          (int choiceNumber, int index, bool isSelected) {
                        setState(() {
                          if (widget.character.optionalOnesStates![choiceNumber]
                              [index]) {
                          ...
                          widget.character.optionalOnesStates![choiceNumber]
                              [index] = !widget
                ...
                if (widget.character.race.mystery2S +
                        (widget.character.subrace?.mystery2S ?? 0) !=
                    0) ...[
                  StyleUtils.buildStyledSmallTextBox(
                      text: "Choose which score(s) to increase by 2"),
                  StyleUtils.buildNStyledAsiSelectors(
                      numbItems: (widget.character.race.mystery2S +
                          (widget.character.subrace?.mystery2S ?? 0)),
                      optionalStatesList: widget.character.optionalTwosStates!,
                      onPressed:
                          (int choiceNumber, int index, bool isSelected) {
                        setState(() {
                          if (widget.character.optionalTwosStates![choiceNumber]
                              [index]) {
                            widget.character.raceAbilityScoreIncreases[index] -=
                                2;
                          } else {
                          ...
                          widget.character.optionalTwosStates![choiceNumber]
                              [index] = !widget
