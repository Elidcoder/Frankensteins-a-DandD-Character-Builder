...
class _AsiFeatTabState extends State<AsiFeatTab> {
              ...
              child: Column(
                children: [
                  ...
                  StyleUtils.buildStyledHugeTextBox(
                      text:
                          "${widget.numberOfRemainingFeatOrASIs} options remaining"),
                          ...
                          child: SizedBox(
                              ...
                              child: Column(
                                children: [
                                  ...
                                  buildAsiBlockRow(
                                      scoreLeft: widget.character.strength,
                                      scoreRight:
                                          widget.character.intelligence),
                                  const SizedBox(height: 10),
                                  buildAsiBlockRow(
                                      scoreLeft: widget.character.dexterity,
                                      scoreRight: widget.character.wisdom),
                                  const SizedBox(height: 10),
                                  buildAsiBlockRow(
                                      scoreLeft: widget.character.constitution,
                                      scoreRight: widget.character.charisma)
                                ],
                              ))),
                            ...
                            child: SizedBox(
                                ...
                                child: Column(
                                  children: [
                                            ...
                                            child: OutlinedButton(
                                                style: OutlinedButton.styleFrom(
                                                    ...
                                                    backgroundColor: (widget
                                                            .character
                                                            .featsSelected
                                                            .containsKey(filteredFeats[
                                                                index]))
                                                        ? Color.fromARGB(
                                                            100 +
                                                                (((widget.character.featsSelected[filteredFeats[index]] ?? 0) / filteredFeats[index].numberOfTimesTakeable) * 155)
                                                                    .ceil(),
                                                            0,
                                                            50 +
                                                                (((widget.character.featsSelected[filteredFeats[index]] ?? 0) / filteredFeats[index].numberOfTimesTakeable) * 205)
                                                                    .ceil(),
                                                            0)
                                                        : Colors.white,
                                                  ...
                                                  setState(() {
                                                    ...
                                                    if (widget
                                                      ...
                                                      if ((widget.character
                                                        ...
                                                        /* Select the feat */
                                                        widget.onRemainingFeatOrASIsChanged(
                                    ...
                                    if (widget.character.featsSelected
                                        .isNotEmpty) ...[
                                      StyleUtils.buildStyledLargeTextBox(
                                          text:
                                              "Selected Feat${displayPlural(widget.character.featsSelected.keys.toList())}:",
                                          color: StyleUtils.currentTextColor),
                                      SizedBox(
                                          height: 50,
                                          child: ListView.builder(
                                            ...
                                            shrinkWrap: true,
                                            itemCount: widget
                                                .character.featsSelected.length,
                                            itemBuilder: (context, index) {
                                              return Tooltip(
                                                  message: GlobalListManager()
                                                      .featList
                                                      .singleWhere((feat) =>
                                                          feat ==
                                                          widget
  ...
  Map<String, bool> featFilters = {"Half Feats": true, "Full Feats": true};

  List<Feat> get filteredFeats {
    List<Feat> feats = GlobalListManager()
        .featList
        .where((feat) =>
  ...
  Container buildAsiBlock({
    ...
    bool scoreBelowMax =
        (score.value + widget.character.featsASIScoreIncreases[index] < 20);
    return StyleUtils.buildStyledContainer(
      height: 136,
      width: 160,
      child: Column(children: [
        StyleUtils.buildStyledMediumTextBox(
            text: score.name, color: StyleUtils.currentTextColor),
        StyleUtils.buildStyledTextBox(
            text: "+${widget.character.featsASIScoreIncreases[index]}",
            size: 45,
            color: StyleUtils.currentTextColor),
        OutlinedButton(
          style: OutlinedButton.styleFrom(
            backgroundColor: ((!widget.remainingAsi &&
  ...
  Widget buildBinarySelectorButton({required String key}) {
