              ...
              Expanded(
                ...
                StyleUtils.buildStyledSmallTextField(
                    ...
                    onChanged: (characterNameEnteredValue) {
                      setState(() {
                        widget.character.characterDescription.name =
                            characterNameEnteredValue;
                      });
                ...
                StyleUtils.buildStyledSmallTextField(
                    ...
                    onChanged: (characterGenderEnteredValue) {
                      setState(() {
                        widget.character.characterDescription.gender =
                            characterGenderEnteredValue;
                      });
                      widget.onCharacterChanged();
                    }),
                const SizedBox(height: 15),
                          ...
                          Container(
                              child: (widget.levellingMethod == "Experience")
                                  ? StyleUtils.buildStyledSmallTextField(
                                      ...
                                      textController:
                                          widget.experienceEnterController,
                                      onChanged:
                                          (characterExperienceEnteredValue) {
                                        setState(() {
                                  ...
                                  : StyleUtils.buildStyledRadioListTile(
                                      ...
                                      groupValue: widget.levellingMethod,
                                      onChanged: (value) {
                                        widget.onLevellingMethodChanged(
                                            value.toString());
                                      },
                                    )),
                    ...
                    child: Column(
                      children: [
                        ...
                        StyleUtils.buildStyledCheckboxListTile(
                            ...
                            value:
                                widget.character.optionalClassFeatures ?? false,
                            onChanged: (bool? value) {
                              setState(() {
                    ...
                    child: Column(
                      children: [
                        StyleUtils.buildStyledCheckboxListTile(
                            ...
                            value:
                                widget.character.criticalRoleContent ?? false,
                            onChanged: (bool? value) {
                              setState(() {
                        ...
                        StyleUtils.buildStyledCheckboxListTile(
                            ...
                            value:
                                widget.character.includeCoinsForWeight ?? false,
                            onChanged: (bool? value) {
                              setState(() {
                            ...
                            onChanged: (bool? value) {
                              setState(() {
                                if (widget.character.classList.isNotEmpty) {
                                  if (widget.character.extraFeatAtLevel1 ??
                                      false) {
                                    if (widget.numberOfRemainingFeatOrASIs >
                                        0) {
