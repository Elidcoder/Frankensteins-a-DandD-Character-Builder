// External Imports
import "package:frankenstein/features/pdf_export/services/pdf_utils.dart"
    show
        formatList,
...
Container buildDisplayBox(Text label, Text value) {
  return Container(
      ...
      child: Column(
          children: [label, SizedBox(height: 3), Container(child: value)]));
}
...
Container buildSpeedBox(Character userCharacter) {
  ...
  int raceRelatedBonus = (userCharacter.subrace == null)
      ? userCharacter.race.walkingSpeed
      : userCharacter.subrace!.walkingSpeed;
  return buildDisplayBox(
      ...
      Container(
          ...
          child: Row(children: [
            ...
            Text(
              ...
              style: TextStyle(
                  fontSize: 9.6,
                  fontItalic: Font.timesBoldItalic(),
                  color: PDF_LIGHT_GREY),
            ),
            Text(" ${userCharacter.maxHealth}",
                style: const TextStyle(
                    fontSize: 10.6, decoration: TextDecoration.underline))
          ]))
    ]),
  );
}
...
Container buildTemporaryHealthBox(Character userCharacter) {
  return Container(
      ...
      decoration: BoxDecoration(
          ...
          color: PDF_WHITE,
          border: Border.all(width: 0.8)),
      child: Text("           Temporary hit points:",
              ...
              children: [
                ...
                Text(
                    ...
                    GlobalListManager()
                        .classList
                        .where((clas) =>
                            userCharacter.classList.contains(clas.name))
                        .fold<Map<String, int>>(
                            {},
                            (map, clas) => map
                              ..update(clas.name, (count) => count + 1,
                                  ifAbsent: () => 1))
                        .entries
        ...
        Container(
            child: Text(
                [
                  ...
                  ...userCharacter.unstackableEquipmentSelected
                      .map((entry) => entry.name),
                  ...userCharacter.stackableEquipmentSelected.entries
