        ...
        Container(
            ...
            child: Column(children: [
              ...
              Container(
                ...
                child: (userCharacter.characterDescription.name
                            .replaceAll(" ", "") ==
                        "")
                    ? Text(
                        "No data to display",
                ...
                children: [
                  ...
                  Container(
                      ...
                      child: FittedBox(
                        ...
                        child: (userCharacter.classLevels.any((x) => x != 0))
                            ? Text(
                                GlobalListManager()
                                    .classList
                                    .asMap()
                                    .entries
                                    .where((entry) =>
                                        userCharacter.classLevels[entry.key] !=
                                        0)
                                    .map((entry) =>
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: FittedBox(
                      fit: BoxFit.scaleDown,
                      child:
                          (userCharacter.playerName.replaceAll(" ", "") == "")
                              ? Text(
                                  "No data to display",
                                )
                              : Text(
                  ...
                  Container(
                    ...
                    child: FittedBox(
                      fit: BoxFit.scaleDown,
                      child: Text("${userCharacter.characterExperience}",
                          style: const TextStyle(
                              decoration: TextDecoration.underline)),
                    ),
                  ),
...
Widget borderedSection(String title, List<Widget> children,
    {double height = 200.0}) {
  return Container(
    height: height,
