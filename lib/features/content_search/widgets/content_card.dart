...
Center buildContentCard(
    Content content, List<Content> list, void Function(Content) onDelete) {
  return Center(
      child: FractionallySizedBox(
          ...
          child: StyleUtils.buildStyledContainer(
              ...
              decoration: BoxDecoration(
                ...
                border:
                    Border.all(color: StyleUtils.currentTextColor, width: 1.5),
                  ...
                  children: [
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        Text(content.sourceBook,
                            style:
                                StyleUtils.buildDefaultTextStyle(fontSize: 14)
